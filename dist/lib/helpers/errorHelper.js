...
var TITLE = 'Catbee@6.2.1 (<a href="https://github.com/catberry/catberry/issues "target="_blank">report an issue</a>)';
var AMP = /&/g;
var LT = /</g;
var GT = />/g;
var QUOT = /\"/g;
...
module.exports = {
  ...
  prettyPrint: function prettyPrint(error, userAgent) {
    ...
    return '<div style="background-color: white; font-size: 12pt;">' + dateString + userAgentString + TITLE + '<br/><br/>' + fullMessage + '<br/><br/>' + escape(stack) + '</div>';
  }
};
...
function escape(value) {
  return value.replace(AMP, '&amp;').replace(LT, '&lt;').replace(GT, '&gt;').replace(QUOT, '&quot;').replace(SINGLE_QUOT, '&#39;').replace(NEW_LINE, '<br/>');
}